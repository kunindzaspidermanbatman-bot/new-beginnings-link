-- Update the venue discount calculation function to properly handle X + Y bundle discounts
...
BEGIN
  ...
  IF venue_record.discount_config->>'isTimeBundleDiscountEnabled' = 'true' 
    ...
    -- X + Y bundle discount logic - calculate complete bundles and remaining hours
...
-- Update the service discount calculation function to properly handle X + Y bundle discounts
