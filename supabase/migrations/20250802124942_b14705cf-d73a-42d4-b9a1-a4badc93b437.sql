-- Fix service discount calculation to properly prioritize venue-level bundle discounts
...
BEGIN
  ...
  IF venue_has_bundle_discount THEN
    -- Use venue-level X + Y bundle discount logic - only apply if booking is exactly multiples of group size
